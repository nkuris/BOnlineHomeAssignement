# ארכיטקטורת מערכת: Platform Care Programs
...
**Platform זה** משרת ארגונים (Tenants) בניהול תוכניות טיפול בחולים עם תוכניות, שלבים, כללים ואוטומציה.
